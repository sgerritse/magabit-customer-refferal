...
const mockRecentActivity = [
  { id: '1', date: '2 days ago', linkType: 'MAGAbit+ Fractional', clicks: 15, status: 'Converted' },
  { id: '2', date: '3 days ago', linkType: 'MAGAbit+ Pro', clicks: 8, status: 'Pending' },
  { id: '3', date: '5 days ago', linkType: 'MAGAbit+ Fractional', clicks: 23, status: 'Converted' },
  { id: '4', date: '1 week ago', linkType: 'MAGAbit+ Pro', clicks: 12, status: 'Converted' },
  { id: '5', date: '1 week ago', linkType: 'MAGAbit+ Fractional', clicks: 19, status: 'Pending' },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="border-b border-border bg-card">
        <div className="container max-w-7xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-card-foreground">Magabit.net</h1>
              <p className="text-muted-foreground mt-1">MLM Backoffice Demo</p>
            </div>
      ...
      <main className="container max-w-7xl mx-auto px-4 py-8 space-y-8">
        ...
        <div className="text-center space-y-2">
          <h2 className="text-2xl font-bold text-foreground">Refer Customers</h2>
          <p className="text-muted-foreground">Share your referral links to track clicks, conversions, and earnings</p>
        </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            {mockReferralLinks.map((link) => (
              <div key={link.id} className="p-4 border border-border rounded-lg bg-card space-y-3 shadow-sm">
                <div className="flex items-center justify-between">
              ...
              <TableBody>
                {mockRecentActivity.map((activity) => (
                  <TableRow key={activity.id}>
                    ...
                    <TableCell>
                      <Badge 
                        className={activity.status === 'Converted' 
